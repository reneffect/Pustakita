...
// Membuat dummy admin jika tabel admin kosong
...
// Membuat dummy kategori jika tabel kategori kosong
...
if (isset($_POST['action'])) {
    if ($_POST['action'] == 'create') {
        ...
        if ($check_kode->num_rows > 0) {
            ...
            $sql = "INSERT INTO buku (id_admin, kode_buku, judul, penulis, penerbit, tahun_terbit, kategori_id, stok, deskripsi) 
                    VALUES ($id_admin, '$kode_buku', '$judul', '$penulis', '$penerbit', '$tahun_terbit', $kategori_id, $stok, '$deskripsi')";
            if ($conn->query($sql)) {
...
// Mengambil semua kategori untuk opsi dropdown form
...
<body class="bg-white flex h-screen font-sans text-gray-800 overflow-hidden">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700">
                            ...
                            ?>
                                ...
                                ?>
                                <tr>
                                    <td colspan="9" class="py-10 text-center text-gray-400 font-medium">
    ...
    <div id="addModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center hidden p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-lg w-full overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <form action="" method="POST" class="overflow-y-auto p-6 space-y-4">
    ...
    <script>
        // Fungsi dasar toggle modal buka-tutup
        ...
        // Fungsi khusus menyuntikkan data baris ke dalam form Edit (Update)
