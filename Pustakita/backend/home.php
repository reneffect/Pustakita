...
<nav>
  ...
  <div class="nav-right">
    ...
    <?php if (isset($_SESSION['siswa'])): ?>
      <span style="color:#111827;font-weight:600;font-size:14px;margin-right:15px;">👤 <?php echo htmlspecialchars($_SESSION['username']); ?></span>
...
<div class="section">
  ...
  <div class="kategori-grid">
    ...
    while ($row = mysqli_fetch_assoc($resultKategori)) {
        ...
        echo '  <div class="kategori-bg ' . $bg . '"></div>';
    ...
    <div class="rekomendasi-books">
      <div class="book-card">
        <div class="book-cover" style="background:linear-gradient(135deg,#1e3a5f,#2d6a9f);">
          ...
          <div class="book-cover-inner">
            <img src="images/3726-mdpl.jpg" alt="3726 MDPL cover" style="width:100%;height:100%;object-fit:cover;">
          </div>
        </div>
        <div class="book-meta">
          <div class="book-author" style="color:#a78bfa;font-size:9px;">Nuannisa Sar</div>
          <div class="book-name" style="color:white;font-size:10px;font-weight:700;">3726 MDPL</div>
        </div>
      </div>
      <div class="book-card">
        <div class="book-cover" style="background:linear-gradient(135deg,#7f1d1d,#b91c1c);">
          <div class="book-badge">BEST SELLER</div>
          <div class="book-cover-inner">
            <img src="images/pulang.jpg" alt="Pulang cover" style="width:100%;height:100%;object-fit:cover;">
          </div>
        </div>
        <div class="book-meta">
      ...
      <div class="book-card">
        <div class="book-cover" style="background:linear-gradient(135deg,#1e4d3e,#059669);">
          <div class="book-badge">BEST SELLER</div>
          <div class="book-cover-inner">
            <img src="images/bandung-after-rain.jpg" alt="Bandung After Rain cover" style="width:100%;height:100%;object-fit:cover;">
          </div>
        </div>
        <div class="book-meta">
      ...
      <div class="book-card">
        <div class="book-cover" style="background:linear-gradient(135deg,#78350f,#d97706);">
          <div class="book-badge">BEST SELLER</div>
          <div class="book-cover-inner">
            <img src="images/laskar-pelangi.jpg" alt="Laskar Pelangi cover" style="width:100%;height:100%;object-fit:cover;">
          </div>
        </div>
        <div class="book-meta">
      ...
      <div class="book-card">
        <div class="book-cover" style="background:linear-gradient(135deg,#4a044e,#9333ea);">
          <div class="book-badge">BEST SELLER</div>
          <div class="book-cover-inner">
            <img src="images/dilan-milea-1990.jpg" alt="Dilan Milea 1990 cover" style="width:100%;height:100%;object-fit:cover;">
          </div>
        </div>
        <div class="book-meta">
  ...
  <div class="favorit-wrapper">
    ...
    <div class="favorit-books">
      ...
      while ($row = mysqli_fetch_assoc($resultFavorit)) {
          ...
          $foto_src = '';
          if (!empty($row['foto'])) {
              $foto_src = strpos($row['foto'], '/') === false
                ? 'admin%20case/uploads/' . htmlspecialchars($row['foto'])
                : str_replace(' ', '%20', htmlspecialchars($row['foto']));
          }
          ...
          if (!empty($foto_src)) {
              echo '    <img src="' . $foto_src . '" alt="Cover" style="width:100%; height:100%; object-fit:cover;">';
          } else {
    ...
    <div class="cta-right">
      <div class="cta-card-pinjam">
        <div>
          ...
          <div class="btn-pinjam">PINJAM →</div>
        </div>
...
<div class="section">
  ...
  <div class="kategori-grid">
    <?php
    $bg_classes = ['cat-pelajaran', 'cat-novel', 'cat-cerita', 'cat-kamus'];
    $i = 0;
    while ($row = mysqli_fetch_assoc($resultKategori)) {
        $bg = isset($bg_classes[$i]) ? $bg_classes[$i] : 'cat-cerita';
        echo '<div class="kategori-card">';
